...
const HAYAH_LOGO = "https://raw.githubusercontent.com/emkas77-dev/hayah-app/main/hayah_logo.png";
const COMPANY_LOGO = "https://raw.githubusercontent.com/emkas77-dev/hayah-app/main/company_logo.jpg";
      ...
      <div style={{ padding: "0 16px 40px", display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        {submitted && (
          <div style={{ background: "rgba(95,214,143,0.1)", border: "1px solid rgba(95,214,143,0.3)", borderRadius: 20, padding: 24, textAlign: "center" }}>
            ...
            <p style={{ color: "#7C93A6", fontSize: 12, margin: "0 0 16px" }}>سيتواصل معك فريق الخدمة قريباً</p>

            {/* WhatsApp Follow-up Button */}
            <a
              href={`https://wa.me/201098138383?text=${encodeURIComponent(
                `مرحباً، أود متابعة طلبي المُسجَّل عبر منصة حياة.\n` +
                `نوع الطلب: ${activeService === "reading" ? "رفع قراءة عداد" : activeService === "connect" ? "طلب توصيل خدمة" : activeService === "pay" ? "تسديد فاتورة" : "تسجيل شكوى"}\n` +
        ...
        <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 20, padding: 16 }}>
          ...
          {[
            ...
            { href: "https://wa.me/201098138383", icon: "💬", label: "واتساب", value: "تواصل معنا عبر WhatsApp", color: "#25D366" },
